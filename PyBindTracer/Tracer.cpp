...
// This function has been conveniently copied 
// from https://github.com/sumerc/yappi/blob/master/yappi/_yappi.c
...
static int profileFunctionCalls(PyObject* obj,
                                PyFrameObject* frame,
                                int what,
                                PyObject* arg)
{
    auto* tracerInformation
        = static_cast<TracerInformation*>(PyCapsule_GetPointer(obj, nullptr));
    ...
    if (!tracerInformation
        ...
        || strcmp(PyUnicode_AsUTF8(code->co_filename), 
                  tracerInformation->m_module.c_str()) != 0)
    {
        return 0;
    }
